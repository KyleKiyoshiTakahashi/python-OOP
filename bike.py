...
# (e.g. bike1 = Bike(200, "25mph"); In the __init__(), also write the code so that the initial miles
# is set to be 0 whenever a new instance is created.
